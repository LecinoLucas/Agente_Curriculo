...
export function CandidateLoginPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[hsl(var(--bg))] px-4 py-8 sm:px-6 lg:px-8">
      {/* Background Orbs */}
      ...
      <div className="relative mx-auto flex w-full max-w-5xl flex-col items-center justify-center gap-8 lg:min-h-[80vh] lg:flex-row lg:gap-16">
        {/* Left Side: Brand & Info */}
        <div className="flex w-full flex-col gap-6 lg:w-1/2 animate-in fade-in slide-in-from-left-8 duration-700">
          <div className="space-y-5 text-center lg:text-left">
            ...
            <div className="inline-flex items-center gap-1.5 rounded-full border border-[hsl(var(--primary)/0.2)] bg-[hsl(var(--primary)/0.05)] px-3 py-1 text-[10px] font-bold uppercase tracking-widest text-[hsl(var(--primary))]">
              <Sparkles className="h-3.5 w-3.5" />
              Ambiente Restrito
            </div>
            <h1 className="font-heading text-4xl sm:text-5xl font-extrabold leading-[1.15] tracking-tight text-[hsl(var(--text))]">
            ...
            <p className="max-w-lg text-sm sm:text-base leading-relaxed text-[hsl(var(--text-muted))] font-medium">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {[
              ...
              <div key={i} className="group rounded-[1.5rem] border border-[hsl(var(--border)/0.4)] bg-[hsl(var(--surface)/0.5)] p-5.5 backdrop-blur-md transition-all hover:border-[hsl(var(--primary)/0.3)] hover:bg-[hsl(var(--surface)/0.8)]">
                <p className="font-bold tracking-tight text-[hsl(var(--text))] group-hover:text-[hsl(var(--primary))] transition-colors">{item.title}</p>
                <p className="mt-1.5 text-xs sm:text-sm leading-relaxed text-[hsl(var(--text-muted))]">{item.desc}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="w-full max-w-md lg:w-1/2 animate-in fade-in slide-in-from-right-8 duration-700 delay-200">
          <Card className="relative overflow-hidden rounded-[1.75rem] border border-[hsl(var(--border)/0.5)] bg-[hsl(var(--surface)/0.8)] shadow-2xl backdrop-blur-xl">
            ...
            <CardHeader className="space-y-1 pt-8 pb-4">
              ...
              <CardDescription className="text-sm">Bem-vindo de volta! Entre com seus dados.</CardDescription>
            </CardHeader>
              ...
              <form className="space-y-5" onSubmit={handleSubmit} noValidate>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    autoComplete="email"
                    className="h-11 rounded-xl border-[hsl(var(--border)/0.8)] bg-[hsl(var(--bg)/0.5)] px-4 text-xs font-semibold focus-visible:ring-[hsl(var(--primary))]"
                    value={email}
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Input
                      ...
                      className="h-11 rounded-xl border-[hsl(var(--border)/0.8)] bg-[hsl(var(--bg)/0.5)] pl-4 pr-12 text-xs font-semibold focus-visible:ring-[hsl(var(--primary))]"
                      value={password}
                ...
                <Button 
                  type="submit" 
                  disabled={isSubmitting}
                  className="h-12 w-full rounded-xl bg-gradient-to-r from-[hsl(var(--primary))] to-[hsl(var(--brand-glow))] text-sm font-bold text-white shadow-xl shadow-[hsl(var(--primary)/0.2)] transition-all hover:scale-[1.01] active:scale-[0.99]"
                >
                  {isSubmitting ? (
                ...
                <Button 
                  variant="outline" 
                  asChild
                  className="h-12 w-full rounded-xl border-2 border-[hsl(var(--primary))] bg-transparent text-sm font-bold text-[hsl(var(--primary))] transition-all hover:bg-[hsl(var(--primary))] hover:text-white active:scale-[0.99]"
                >
