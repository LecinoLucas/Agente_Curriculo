    ...
    columns: columns.map((column) => ({
      ...
      candidates: Array.isArray(column.candidates)
        ? column.candidates.map((item) => ({
            ...
            requires_behavioral_assessment: item.requires_behavioral_assessment ?? null,
            requires_behavioral_ai_evaluation: item.requires_behavioral_ai_evaluation ?? null,
            requires_interview: item.requires_interview ?? null,
            requires_scorecard: item.requires_scorecard ?? null,
            behavioral_assessment_status: item.behavioral_assessment_status ?? null,
            behavioral_submitted_at: item.behavioral_submitted_at ?? null,
            behavioral_ai_evaluation_status: item.behavioral_ai_evaluation_status ?? null,
