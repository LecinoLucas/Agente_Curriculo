  ...
  return (
    <div className="space-y-8">
      <div className="space-y-2">
        ...
        <h2 className="text-2xl font-bold tracking-tight text-text font-heading">Como você deseja começar?</h2>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <div className="flex flex-col justify-between rounded-[2rem] border border-[hsl(var(--border)/0.5)] bg-[hsl(var(--surface)/0.65)] p-6 shadow-sm hover:shadow-md hover:border-[hsl(var(--primary)/0.25)] transition-all duration-300 relative overflow-hidden group">
          ...
          <div className="space-y-2">
            <h3 className="font-heading text-lg font-bold text-text">Cadastro com Google</h3>
        ...
        <div className="flex flex-col justify-between rounded-[2rem] border border-[hsl(var(--border)/0.5)] bg-surface p-6 shadow-sm hover:shadow-md hover:border-[hsl(var(--primary)/0.25)] transition-all duration-300 relative overflow-hidden group">
          <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-[hsl(var(--primary))]/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
          <div className="space-y-2">
            <h3 className="font-heading text-lg font-bold text-text">Cadastro tradicional</h3>
            <p className="text-[13px] text-text-muted leading-relaxed">
      ...
      <div className="rounded-2xl bg-[hsl(var(--surface-muted)/0.3)] border border-[hsl(var(--border)/0.25)] p-4 text-[13px] text-text-muted leading-relaxed">
