...
export const PIPELINE_MACRO_COLUMNS: readonly PipelineMacroColumnConfig[] = [
  {
    id: "entrada",
    label: "Entrada",
    description: "Inscrições e currículos recebidos",
    stages: ["entry"],
  ...
  },
  {
    id: "analise",
    label: "Análise",
    description: "Triagem e análise inicial",
    stages: ["screening"],
  ...
  },
  {
    id: "avaliacao",
    label: "Avaliação",
    description: "Avaliações e etapa final",
    stages: ["final"],
  ...
  },
  {
    id: "entrevista",
    label: "Entrevista",
    description: "Entrevistas RH, técnica e scorecard",
  ...
  },
  {
    id: "decisao",
    label: "Decisão",
    description: "Oferta, decisão e negociação",
    stages: ["offer"],
  ...
  },
  {
    id: "admissao",
    label: "Admissão",
    description: "Contratação, pré-admissão e Protheus",
  ...
  },
  {
    id: "finalizado",
    label: "Finalizado",
    description: "Admitidos e encerrados",
