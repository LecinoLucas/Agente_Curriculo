    ...
    <div className="rounded-lg border border-[hsl(var(--border))] bg-white p-4">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        <div>
          ...
          <h3 className="mt-1 text-base font-semibold text-[hsl(var(--text))]">
        ...
        <label className="block space-y-1 text-sm">
          ...
          <select
            ...
            disabled={updating}
            className="w-full rounded-lg border border-[hsl(var(--border))] bg-[hsl(var(--surface))] px-3 py-2 text-sm disabled:opacity-60 sm:w-64"
          >
      ...
      <div className="mt-4 grid gap-3 sm:grid-cols-2">
        <div className="flex items-start gap-2 rounded-md border border-[hsl(var(--border))] bg-[hsl(var(--surface-muted))]/30 p-3">
          <CircleDollarSign className="mt-0.5 h-4 w-4 text-[hsl(var(--primary))]" />
          <div>
            <div className="text-[11px] font-semibold uppercase text-[hsl(var(--text-muted))]">Oferta</div>
      ...
      {preAdmissionCase.work_model || preAdmissionCase.notes ? (
        <div className="mt-4 rounded-md border border-[hsl(var(--border))] bg-[hsl(var(--surface-muted))]/30 p-3 text-sm text-[hsl(var(--text-muted))]">
