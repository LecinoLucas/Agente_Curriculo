...
export function TopNavbar({
  ...
  return (
    <header className="absolute top-0 left-0 right-0 z-50 flex h-14 w-full items-center justify-between bg-transparent px-3 shadow-none sm:px-4 pointer-events-none lg:hidden">
