...
class CommunicationResponse(BaseModel):
    ...
    id: str = Field(..., description="Communication UUID")
    candidate_id: str = Field(..., description="Candidate UUID")
    job_id: Optional[str] = Field(None, description="Job UUID")
    related_entity_type: Optional[str] = Field(None, description="Entity type for deduplication")
    related_entity_id: Optional[str] = Field(None, description="Entity ID for deduplication")
